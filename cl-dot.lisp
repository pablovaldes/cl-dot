...
(defvar *dot-path*
 ...
 ; #-(or win32 mswindows) "/usr/bin/dot"
   #-(or win32 mswindows) (make-pathname :directory '(:absolute "usr" "bin") :name "dot" :type nil)
...
;  #-(or win32 mswindows) "/usr/bin/neato"
   #-(or win32 mswindows) (make-pathname :directory '(:absolute "usr" "bin") :name "neato" :type nil)
